...
export default function Electricity() {
  ...
  const buy = async (e) => {
    ...
    try {
      ...
      setPurchaseResult({
        ok: true,
        reference: res.reference || `MELE-ELECTRICITY-${Date.now()}`,
      ...
      setPurchaseResult({
        ok: false,
        reference: `MELE-ELECTRICITY-ATTEMPT-${Date.now()}`,
        status: "failed",
  ...
  const downloadReceipt = async () => {
    ...
    try {
      ...
      pdf.save(`meledata-electricity-receipt-${safeReference}.pdf`);
  ...
  const shareReceipt = async () => {
    ...
    try {
      ...
      const result = await shareReceiptCapture({
        ...
        title: "MELE DATA Electricity Receipt",
        text: shareText(),
        fileName: `meledata-electricity-receipt-${safeReference}.png`,
      });
      if (!result.ok) {
