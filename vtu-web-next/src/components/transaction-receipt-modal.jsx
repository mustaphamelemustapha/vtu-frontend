        ...
        >
          ...
          >
            <div className="border-b border-border px-5 py-4 md:px-6">
              <div className="flex items-start justify-between gap-4">
                <div className="flex items-center gap-3">
                  <div className="relative h-9 w-[112px]">
                    <Image src="/brand/axisvtu-logo.png" alt="AxisVTU" fill className="object-contain object-left" />
                  </div>
            ...
            <div className="max-h-[min(78vh,740px)] space-y-4 overflow-y-auto px-5 py-5 md:px-6">
              <div className="rounded-2xl border border-border bg-secondary px-4 py-4">
                <div className="flex items-start gap-3">
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <div className="mt-1 text-sm text-muted-foreground">{receipt.service}</div>
              ...
              <div className="rounded-2xl border border-border bg-secondary px-4 py-2">
                {rows.map((row) => (
          ...
          <div className="pointer-events-none fixed -left-[9999px] top-0 w-[560px]">
            <div ref={pdfReceiptRef} className="w-[560px] rounded-2xl bg-white p-6 text-slate-900">
              <div className="flex items-center justify-between gap-4 border-b border-slate-200 pb-4">
                <Image src="/brand/axisvtu-logo.png" alt="AxisVTU" width={130} height={34} className="h-8 w-auto object-contain" />
